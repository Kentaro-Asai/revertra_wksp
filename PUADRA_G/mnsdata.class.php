	...
	public function lstMns($num)
	{
		$mns_ary = array(
			...
			31 => array(
				...
				array("no"=> 4696, "nm"=> "ヘレネー", "rr"=> 5, "pc"=> 8.16),
				array("no"=> 4697, "nm"=> "コノハナサクヤ", "rr"=> 5, "pc"=> 8.16),
				array("no"=> 4698, "nm"=> "テンフーファ", "rr"=> 5, "pc"=> 8.16),
				...
				array("no"=> 4709, "nm"=> "疾風の獣戦士アタランテー", "rr"=> 5, "pc"=> 8.16),
