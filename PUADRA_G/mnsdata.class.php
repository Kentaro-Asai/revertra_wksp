...
class mnsdata {
	...
	public function lstMns($num)
	{
		$mns_ary = array(
			...
			36 => array(
				array("no"=> 6004, "nm"=> "ミッキー＆フレンズ", "rr"=> 7, "pc"=> 2),
				array("no"=> 6007, "nm"=> "ミッキーマウス", "rr"=> 6, "pc"=> 6),
				array("no"=> 6014, "nm"=> "ミニーマウス", "rr"=> 6, "pc"=> 6),
				array("no"=> 6018, "nm"=> "ドナルドダック", "rr"=> 6, "pc"=> 6),
				array("no"=> 6022, "nm"=> "グーフィー", "rr"=> 5, "pc"=> 16),
				array("no"=> 6025, "nm"=> "プルート", "rr"=> 5, "pc"=> 16),
				array("no"=> 6028, "nm"=> "デイジーダック", "rr"=> 5, "pc"=> 16),
				array("no"=> 6031, "nm"=> "ヒューイ＆デューイ＆ルーイ", "rr"=> 5, "pc"=> 16),
				array("no"=> 6034, "nm"=> "スクルージ", "rr"=> 5, "pc"=> 16),
			)
		);
		return $mns_ary[$num];
	}
