...
class mnsdata {
	...
	public function lstMns($num)
	{
		$mns_ary = array(
			...
			21 => array(
				array("no"=>2406, "nm" => "古城の青龍喚士・ソニア", "rr"=> 7, "pc"=> 3.5),
				//array("no"=>2407, "nm" => "古城の女主神・カーリー", "rr"=> 8, "pc"=> 1),
				//array("no"=>2408, "nm" => "仮装祭の来賓・イザナミ", "rr"=>4, "pc"=> 13),
				array("no"=>2409, "nm" => "好奇の客人・ライラ", "rr"=> 6, "pc"=> 6),
				array("no"=>2410, "nm" => "月夜の魔狼・ヴァンパイアロード", "rr"=> 6, "pc"=> 6),
				array("no"=>2411, "nm" => "仮装祭の精霊・アルラウネ", "rr"=> 6, "pc"=> 6),
				//array("no"=>2412, "nm" => "遊戯の星知神・トト＆ソティス", "rr"=> 4, "pc"=> 13),
				//array("no"=>3222, "nm" => "紅蘭の黒魔女・シャンメイ", "rr"=> 8, "pc"=> 1),
				array("no"=>3223, "nm" => "古城の居候・龍喚士ソニア＝グラン", "rr"=> 8, "pc"=> 2.5),
				array("no"=>3224, "nm" => "演舞の青龍姫・カリン", "rr"=> 6, "pc"=> 6),
				array("no"=>3225, "nm" => "仮装祭の小悪魔・ロズエル", "rr"=> 6, "pc"=> 6),
				array("no"=>3226, "nm" => "御茶屋の看板娘・望月千代女", "rr"=> 5, "pc"=> 8),
				array("no"=>3227, "nm" => "仮装祭の女神・パールヴァティー", "rr"=> 5, "pc"=> 8),
				array("no"=>3228, "nm" => "古城のパティシエール・ウンディーネ", "rr"=>5, "pc"=> 8),
				array("no"=>3229, "nm" => "仮装祭のカボチャ職人・ムーラン", "rr"=> 5,"pc"=> 8),
				array("no"=>3230, "nm" => "仮装祭のロックシンガー・ミザリィ", "rr"=> 5,"pc"=> 8),
				array("no"=>3994, "nm" => "周遊の時女神・ヴェルダンディ", "rr"=> 8, "pc"=> 2.5),
				array("no"=>3995, "nm" => "仮装祭の後援・ねね", "rr"=> 7, "pc"=> 3.5),
				array("no"=>3996, "nm" => "遊戯の星天使・リュエル", "rr"=> 7, "pc"=> 3.5),
				array("no"=>4830, "nm" => "仮装祭の玩龍喚士・コットン", "rr"=> 8, "pc"=> 2.5),
				array("no"=>4831, "nm" => "甘党の幻龍王・ゼローグ∞", "rr"=> 7, "pc"=> 3.5),
				array("no"=>5621, "nm" => "城下の大魔女・マドゥ", "rr"=> 9, "pc"=> 1.5),
				array("no"=>5623, "nm" => "巡遊の龍喚士・アルファ＆オメガ", "rr"=> 7, "pc"=> 3.5),
				array("no"=>5624, "nm" => "古城の守り猫・バステト", "rr"=> 7, "pc"=> 3.5),
			),
			22 => array(
