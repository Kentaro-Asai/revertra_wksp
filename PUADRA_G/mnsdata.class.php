...
class mnsdata {
	...
	public function lstMns($num)
	{
		$mns_ary = array(
			...
			27 => array(
				array("no"=>5639, "nm" => "リナ＝インバース", "rr"=> 8, "pc"=> 1.5),
				array("no"=>5643, "nm" => "ガウリイ＝ガブリエフ", "rr"=> 7, "pc"=> 2.5),
				array("no"=>5646, "nm" => "オーフェン", "rr"=> 7, "pc"=> 2.5),
				array("no"=>5650, "nm" => "クリーオウ・エバーラスティン", "rr"=> 7, "pc"=> 2.5),
				array("no"=>5653, "nm" => "相良宗介", "rr"=> 7, "pc"=> 2.5),
				array("no"=>5657, "nm" => "千鳥かなめ", "rr"=> 7, "pc"=> 2.5),
				array("no"=>5660, "nm" => "ゼルガディス＝グレイワーズ", "rr"=> 6, "pc"=> 13.75),
				array("no"=>5661, "nm" => "アメリア＝ウィル＝テスラ＝セイルーン", "rr"=> 6, "pc"=> 3.5),
				array("no"=>5666, "nm" => "獣神官ゼロス", "rr"=> 6, "pc"=> 13.75),
				array("no"=>5662, "nm" => "マジク・リン", "rr"=> 6, "pc"=> 13.75),
				array("no"=>5663, "nm" => "ボルカン＆ドーチン", "rr"=> 6, "pc"=> 13.75),
				array("no"=>5664, "nm" => "メリッサ・マオ", "rr"=> 6, "pc"=> 13.75),
				array("no"=>5665, "nm" => "クルツ・ウェーバー", "rr"=> 6, "pc"=> 13.75),
			)
		);
		return $mns_ary[$num];
	}
