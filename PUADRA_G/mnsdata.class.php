...
class mnsdata
{
	...
	public function lstMns($num)
	{
		$mns_ary = array(
			...
			10 => array(
				array("no"=>3605, "nm" => "ナツ", "rr"=> 6, "pc"=> 2),
				array("no"=>3607, "nm" => "ルーシィ", "rr"=> 5, "pc"=> 18),
				array("no"=>3608, "nm" => "メリオダス", "rr"=> 6, "pc"=> 2),
				array("no"=>3610, "nm" => "エリザベス", "rr"=> 5, "pc"=> 18),
				array("no"=>3611, "nm" => "サクラ", "rr"=> 6, "pc"=> 2),
				array("no"=>3613, "nm" => "小狼", "rr"=> 5, "pc"=> 18),
				array("no"=>3614, "nm" => "パイ", "rr"=> 6, "pc"=> 2),
				array("no"=>3616, "nm" => "藤井八雲", "rr"=> 5, "pc"=> 18),
				array("no"=>3617, "nm" => "陸奥九十九 ", "rr"=> 6, "pc"=> 2),
				array("no"=>3619, "nm" => "龍造寺舞子", "rr"=> 5, "pc"=> 18),
			),
			11 => array(
